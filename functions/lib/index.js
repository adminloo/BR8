...
exports.stopBillingPubSub = exports.onBathroomReport = exports.onNewBathroomSubmission = exports.verifyBathroom = void 0;
/**
...
const billingUtils_1 = require("./billingUtils");
...
exports.verifyBathroom = (0, https_1.onRequest)(async (req, res) => {
    try {
        ...
        const pendingRef = db.collection("pendingBathrooms").doc(id);
        ...
        if (action === "approve") {
            ...
            const approvedBathroomData = Object.assign(Object.assign({}, bathroomData), { id: verifiedRef.id, status: "VERIFIED", sourcePendingId: id, verifiedAt: now, updatedAt: now, ratingCount: (bathroomData === null || bathroomData === void 0 ? void 0 : bathroomData.ratingCount) || 1, totalRating: (bathroomData === null || bathroomData === void 0 ? void 0 : bathroomData.totalRating) || 3, 
                // Ensure required fields are present
                isAccessible: Boolean(bathroomData === null || bathroomData === void 0 ? void 0 : bathroomData.isAccessible), hasChangingTables: Boolean(bathroomData === null || bathroomData === void 0 ? void 0 : bathroomData.hasChangingTables), requiresKey: Boolean(bathroomData === null || bathroomData === void 0 ? void 0 : bathroomData.requiresKey) });
...
exports.onNewBathroomSubmission = (0, firestore_1.onDocumentCreated)("pendingBathrooms/{bathroomId}", async (event) => {
...
exports.onBathroomReport = (0, firestore_1.onDocumentCreated)("reports/{reportId}", async (event) => {
    const snapshot = event.data;
    if (!snapshot) {
        console.log("No data associated with the event");
        return;
...
async function sendDiscordAlert(message) {
    if (!config_1.discordWebhookUrl)
        return;
    try {
        await (0, node_fetch_1.default)(config_1.discordWebhookUrl, {
            method: "POST",
            headers: {
...
exports.stopBillingPubSub = (0, pubsub_1.onMessagePublished)("loo_cap_billing", async (event) => {
...
Billing Period Start: ${new Date(costIntervalStart).toLocaleDateString()}`;
    ...
    if (fractionConsumed >= config_1.DISABLE_BILLING_THRESHOLD) {
        ...
        const billingResponse = await (0, billingUtils_1.disableBillingForProject)();
        if (billingResponse) {
